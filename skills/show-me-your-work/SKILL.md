...
description: Use to keep a TSV decision trail for long-running, unattended, multi-phase, or review-after-the-fact work.
...
- Prefer evidence produced by committed scripts over hand-made one-offs, so a reviewer can re-run it. See `../poteto-mode/references/principles/encode-lessons-in-structure.md`.
