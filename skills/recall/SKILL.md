---
name: recall
description: Use to reconstruct recent work from chat history, live state, user reports, prior fixes, and incidents.
...
An adjacent feature or ticket stays out unless it blocks this one. When the capsule and thread lines outgrow a screen, cut detail before you cut threads. Write the brief with the plain-prose rules from **poteto-mode**: concrete, cited, free of AI tells. Cite chat findings by UUID and shared-record findings by their source (PR #, ticket ID, chat permalink, error-tracker issue), and sanitize private context before any public output.
