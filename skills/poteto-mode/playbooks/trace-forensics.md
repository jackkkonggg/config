...
1. Identify the format and load it with the right tool. Parse large artifacts in a subagent ([Guard the Context Window](../references/principles/guard-the-context-window.md)) and keep the reduced finding in the main thread.
