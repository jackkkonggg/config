...
5. Verify the inherited claims against the original goal on the real artifact ([Prove It Works](../references/principles/prove-it-works.md)). A passing prior self-report is not the proof.
