...
- Numbers in tables right-align to the trailing edge (see the typography references for tabular figures); text left-aligns to the leading edge.
...
- One primary action per view (see the color references for how color enforces this).
