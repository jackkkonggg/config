...
When text appears low-contrast, use the color references to measure the rendered foreground/background pair and the accessibility references to classify the applicable requirement. Changing the project's colors remains a design decision unless the user asks for remediation.
