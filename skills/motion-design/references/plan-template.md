...
Every motion implementation plan follows this structure. The executor may have
no prior context, so the plan must contain the necessary evidence and exact
values. Do not refer to “the audit above” or “the easing we discussed.”
